...
AQUARIUS_TCP_HANDLER(login_tcp_request, login_tcp_response, ctx_tcp_test)
{
...
AQUARIUS_HTTP_HANDLER(new_http_login_http_request, new_http_login_http_response, ctx_test_http_hander)
{
...
AQUARIUS_HTTP_HANDLER(http_test_get_http_request, http_test_get_http_response, ctx_http_test_get_request)
{
	if (!request())
	{
