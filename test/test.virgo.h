...
using new_http_login_request = aquarius::virgo::http_request<"/login/new", aquarius::virgo::http_method::post, new_http_login_req_body>;
using new_http_login_response = aquarius::virgo::http_response<aquarius::virgo::http_method::post, new_http_login_resp_body>;
