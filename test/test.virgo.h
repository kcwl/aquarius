...
using new_http_login_request = aquarius::virgo::http_request<"login/new", aquarius::virgo::http_method::get, aquarius::http_request_header, new_http_login_request_body>;
...
using new_http_login_response = aquarius::virgo::http_response<"login/new", aquarius::virgo::http_method::post, aquarius::http_response_header, new_http_login_response_body>;
...
using http_test_get_request = aquarius::virgo::http_request<"login", aquarius::virgo::http_method::post, aquarius::http_request_header, http_test_get_request_body>;
...
using http_test_get_response = aquarius::virgo::http_response<"login", aquarius::virgo::http_method::post, aquarius::http_response_header, http_test_get_response_body>;
...
//using new_http_login_response = aquarius::virgo::http_response<"login/new", aquarius::virgo::http_method::get, aquarius::http_response_header, new_http_login_response_body>;
...
using http_login_request = aquarius::virgo::http_request<"login", aquarius::virgo::http_method::post, http_login_request_header, http_login_request_body>;
using http_login_response = aquarius::virgo::http_response<"login", aquarius::virgo::http_method::post, http_login_response_header, http_login_response_body>;
