...
#define AQUARIUS_STREAM_CONTEXT()                                                                                      \
	[[maybe_unused]] static aquarius::tcp::auto_context_register<                                                      \
		aquarius::tcp::server_session, aquarius::tcp::stream_context> __auto_context_register_stream;

#define AQUARIUS_BROADCAST_CONTEXT()                                                                                   \
	[[maybe_unused]] static aquarius::tcp::auto_context_register<                                                      \
		aquarius::tcp::server_session, aquarius::tcp::broadcast_context> __auto_context_register_broadcast;

#define AQUARIUS_TRANSFER_CONTEXT()                                                                                    \
	class transfer_handler;                                                                                            \
	[[maybe_unused]] static aquarius::tcp::auto_context_register<aquarius::tcp::server_session,                        \
																 aquarius::tcp::transfer_context<transfer_handler>>    \
