...
#define AQUARIUS_SERVER_CONTEXT(method, __request, __response)                                                         \
	class method;                                                                                                      \
	[[maybe_unused]] static aquarius::tcp::auto_register<                                                              \
		aquarius::basic_session<aquarius::tcp::async_io_service<aquarius::ssl::no_ssl_protocol>,                       \
								aquarius::package_processor>,                                                          \
		__request, method> __auto_register_##method(__request::Number);                                                \
	class method : public aquarius::tcp::server_context<__request, __response>                                         \
	{                                                                                                                  \
	public:                                                                                                            \
		using request_type = __request;                                                                                \
		using base_type = aquarius::tcp::server_context<__request, __response>;                                        \
	public:                                                                                                            \
		method()                                                                                                       \
...
#define AQUARIUS_CLIENT_CONTEXT(method, __response)                                                                    \
	...
	[[maybe_unused]] static aquarius::tcp::auto_register<                                                              \
		aquarius::basic_session<aquarius::tcp::async_io_service<aquarius::ssl::no_ssl_protocol>,                       \
								aquarius::package_processor>,                                                          \
		__response, method> __auto_register_##method(__response::Number);                                              \
	class method : public aquarius::tcp::client_context<__response>                                                    \
	{                                                                                                                  \
	public:                                                                                                            \
		using base_type = aquarius::tcp::client_context<__response>;                                                   \
	public:                                                                                                            \
		method()                                                                                                       \
