...
namespace aquarius
{
	namespace detail
	{
		namespace impl
		{
			...
			public:
				auto visit(std::shared_ptr<Session> session_ptr, std::shared_ptr<Request> request)
					-> awaitable<error_code>
				{
			...
			protected:
				...
				{
					return impl::defer<Session, T>(id);
				}
			...
			struct auto_handler_register
			{
				...
				{
					impl::handler_router<Protocol>::get_mutable_instance().template regist<RPC, Context>(proto);
				}
			};
		} // namespace impl
	} // namespace detail
...
#define AQUARIUS_HANDLER(__session, method, __request)                                                                 \
	class method final : public aquarius::detail::impl::basic_handler<__session, __request>                            \
	{                                                                                                                  \
	public:                                                                                                            \
		using base_type = aquarius::detail::impl::basic_handler<__session, __request>;                                 \
                                                                                                                       \
	public:                                                                                                            \
		method()                                                                                                       \
...
#define AQUARIUS_POSITIVE_HANDLER(__session, method, __request, __response)                                            \
	class method final : public aquarius::detail::impl::basic_positive_handler<__session, __request, __response>       \
	{                                                                                                                  \
	public:                                                                                                            \
		using base_type = aquarius::detail::impl::basic_positive_handler<__session, __request, __response>;            \
                                                                                                                       \
	public:                                                                                                            \
		method()                                                                                                       \
			: base_type(AQUARIUS_GLOBAL_STR_ID(__handler_##method))                                                    \
