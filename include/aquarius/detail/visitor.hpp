...
namespace aquarius
{
	namespace detail
	{
		...
		public:
			virtual _Return accept(std::shared_ptr<basic_visitor> ctx, std::shared_ptr<xsession> session_ptr) = 0;
		};
...
#define DEFINE_VISITOR(_Request, _Return)                                                                              \
	virtual _Return visit([[maybe_unused]]std::shared_ptr<_Request>, [[maybe_unused]] std::shared_ptr<aquarius::xsession>)       \
	{                                                                                                                  \
		return _Return{};                                                                                              \
	}
