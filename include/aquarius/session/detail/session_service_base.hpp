...
#include <aquarius/session/detail/socket_base.hpp>
		...
		namespace detail
		{
			...
			public:
				...
				void destroy(implementation_type_base& impl)
				{
					...
					impl.socket->shutdown(aquarius::session::detail::socket_base::shutdown_both, ec);
				...
				bool keep_alive(implementation_type_base& impl, bool value)
				{
					...
					impl.socket->set_option(aquarius::session::detail::socket_base::keep_alive(value), ec);
