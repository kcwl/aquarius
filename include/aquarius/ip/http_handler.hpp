...
#define AQUARIUS_HTTP_POST_HANDLER(__request, __response, __method)                                                    \
	AQUARIUS_CONTEXT_BY_HTTP(__request, __response, __method, aquarius::http_router<aquarius::http_server_session>,    \
							 aquarius::virgo::http_method::post)
...
#define AQUARIUS_HTTP_PUT_HANDLER(__request, __response, __method)                                                     \
	AQUARIUS_CONTEXT_BY_HTTP(__request, __response, __method, aquarius::http_router<aquarius::http_server_session>,    \
							 aquarius::virgo::http_method::put)
...
#define AQUARIUS_HTTP_HEAD_HANDLER(__request, __response, __method)                                                    \
	AQUARIUS_CONTEXT_BY_HTTP(__request, __response, __method, aquarius::http_router<aquarius::http_server_session>,    \
							 aquarius::virgo::http_method::head)

#define AQUARIUS_HTTP_REDIRECT_FOREVER(src, dest)                                                                      \
	AQUARIUS_CONTEXT_BY_REDIRECT(aquarius::http_router<aquarius::http_server_session>,                                 \
