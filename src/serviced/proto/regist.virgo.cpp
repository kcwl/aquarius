...
struct publish_req_body::impl
{
	std::vector<string> topics;
};
publish_req_body::publish_req_body()
	: impl_ptr_(std::make_shared<impl>())
{}

publish_req_body::~publish_req_body(){}

void publish_req_body::to_binary(flex_buffer& buffer)
{
	binary_parse::to_datas(impl_ptr_->topics, buffer);
}
void publish_req_body::from_binary(flex_buffer& buffer)
{
	impl_ptr_->topics = binary_parse::from_datas<std::vector<string>>(buffer);
}
void publish_req_body::to_json(flex_buffer& buffer)
{
	json::value jv{};
	auto& jv_obj = jv.emplace_object();
...
void publish_req_body::from_json(flex_buffer& buffer)
{
	json::value jv = json::parse(std::string((char*)buffer.data().data(), buffer.size()));
	auto jv_obj = jv.try_as_object();
	if(jv_obj.has_error())
...
void publish_req_body::to_kv(flex_buffer& buffer)
{
	buffer.sputc('?');
	kv_parse::to_datas(impl_ptr_->topics, buffer);
}
void publish_req_body::from_kv(flex_buffer& buffer)
{
	impl_ptr_->topics = kv_parse::from_datas<std::vector<string>>(buffer, impl_ptr_->topics);
}
std::vector<string> publish_req_body::topics() const
{
	return impl_ptr_->topics;
}
std::vector<string>& publish_req_body::topics()
{
	return impl_ptr_->topics;
}
struct publish_resp_body::impl
{
};
publish_resp_body::publish_resp_body()
	: impl_ptr_(std::make_shared<impl>())
{}

publish_resp_body::~publish_resp_body(){}

void publish_resp_body::to_binary(flex_buffer& buffer)
{
}
void publish_resp_body::from_binary(flex_buffer& buffer)
{
}
void publish_resp_body::to_json(flex_buffer& buffer)
{
}
void publish_resp_body::from_json(flex_buffer& buffer)
{
}
void publish_resp_body::to_kv(flex_buffer& buffer)
{
}
void publish_resp_body::from_kv(flex_buffer& buffer)
{
}
