...
namespace aquarius
{
	namespace gateway
	{
		transfer_module::transfer_module(const std::string& name)
			: _module<transfer_module, transfer_config>(name)
		{}

		auto transfer_module::run(io_context& ios) -> awaitable<void>
		{
