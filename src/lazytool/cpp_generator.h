...
namespace aquarius
{
	namespace lazytool
	{
        ...
        private:
            ...
            void generate_inheritance_serialize_define(std::fstream& ofs);
            ...
            bool generate_seialize_method_binary(std::fstream& ofs, std::shared_ptr<field_base> field_ptr);
            bool generate_seialize_method_json(std::fstream& ofs, std::shared_ptr<field_base> field_ptr);
            bool generate_seialize_method_kv(std::fstream& ofs, std::shared_ptr<field_base> field_ptr);
